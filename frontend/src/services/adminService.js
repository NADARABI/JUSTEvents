...
export const reviewEvent = (eventId, payload) => api.post(`/approve/event/${eventId}`, payload);
...
export const fetchEventOfWeek = () => api.get('/analytics/events/event-of-the-week'); // ✅ جديد
